...
<div class="wrapper">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    @if(auth()->user()->isAdmin() || auth()->user()->isTeacher())
                        <li class="nav-item">
                            <a href="{{ route('courseApprovalList.index') }}" class="nav-link">
                    ...
                    @endif
                    <li class="nav-item">
                        <a href="{{ route('posts.allPost') }}" class="nav-link">
                            <i class="nav-icon fa fa-edit"></i>
                            All Posts
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('myApprovalcourse') }}" class="nav-link">
                            <i class="nav-icon fa fa-edit"></i>
                            My Course
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ url('/poll/create') }}" class="nav-link">
                            <i class="nav-icon fa fa-edit"></i>
                            Create Poll
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ url('/pollanswer/create') }}" class="nav-link">
                            <i class="nav-icon fa fa-edit"></i>
                            View Polls
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ url('/poll') }}" class="nav-link">
                            <i class="nav-icon fa fa-edit"></i>
                            View Poll Answers
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a href="{{ route('courseApproval.index') }}" class="nav-link">
                            <i class="nav-icon fa fa-edit"></i>
                            Course Approval
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('trashed_posts.index') }}" class="nav-link">
                            <i class="nav-icon fa fa-edit"></i>
                            Trashed Posts
                        </a>
                    </li>
    ...
    <footer class="main-footer">
        <strong>Copyright &copy; {{ date('Y') }} <a href="javascript:void(0)"></a>.</strong>
        All rights reserved.
