...
<div class="row justify-content-center">
  <div class="col-md-8">
    <div class="card card-default">
      <div class="card-header"><?php echo e(isset($post) ? 'Edit Post': 'Create Post'); ?></div>
      <div class="card-body">
        ...
        <?php endif; ?>
        <form action="<?php echo e(isset($post) ? route('post.update', $post->id) : route('post.store')); ?>" method="POST" enctype="multipart/form-data">
      ...
      <input id="description" type="hidden" name="description" value="<?php echo e(isset($post) ? $post->description : ''); ?>" >
